/*
	Ёлементы массива ј(N), значени€ которых Ц простые числа, расположить в пор€дке возрастани€, не наруша€ пор€дка следовани€ других элементов.
*/
...
{
	cout << "¬ведите диапазон значений (a,b): ";
	cin >> min >> max;
}
